...
(
    ...
    `title`      varchar(50) CHARACTER SET utf8mb4mb4 COLLATE utf8mb4mb4_general_ci NOT NULL COMMENT '标题',
    `content`    mediumtext CHARACTER SET utf8mb4mb4 COLLATE utf8mb4mb4_general_ci  NOT NULL COMMENT '内容',
