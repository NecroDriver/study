...
(
    ...
    `flag_delete` tinyint(1)                                                    NOT NULL DEFAULT 0 COMMENT '是否删除，0：否 1：是',
    `flag_update` tinyint(1)                                                    NOT NULL DEFAULT 0 COMMENT '是否更新,0:否 1:是',
    `flag_end`    tinyint(1)                                                    NOT NULL DEFAULT 0 COMMENT '是否完结,0:否 1:是',
